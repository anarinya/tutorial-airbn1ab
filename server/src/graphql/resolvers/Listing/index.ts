...
import { 
  ListingArgs, ListingsArgs, ListingsData, ListingBookingsArgs, 
  ListingBookingsData, ListingsFilter, ListingsQuery, HostListingArgs, HostListingInput } from "./types";
  ...
  Query: {
    ...
    listings: async (
      ...
      try {
        ...
        throw new Error(`Failed to query user listings: ${err.json.error_message}`);
      }
    }
  },
  Listing: {
